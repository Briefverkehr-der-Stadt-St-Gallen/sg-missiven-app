...
## Build stgm
* simply run the command `ant` in your terminal in the stgm folder and install the data package (see below).
...
1. in stgm modules/config.xqm set $config:webcomponents-cdn to ‘local’ 
